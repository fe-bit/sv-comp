...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        vts_train, vts_test = get_train_test_data(n=1500, test_size=0.1, random_state=42)

        knn_1_best_summary = evaluate_knn_1_best_verifier(vts_train, vts_test)
        print("KNN 1 Best Verifier")
        knn_1_best_summary.pretty_print()
        ...
        print("KNN 5 Best Verifier")
        knn_5_best_summary.pretty_print()
        ...
        print("Category Best Verifier")
        category_summary.pretty_print()
        ...
        print("Virtually Best Verifier")
        best_summary.pretty_print()
